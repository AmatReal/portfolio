# 6a227b71-c212-4db0-b372-db88dd45cdcc implementation handoff

This archive is the source of truth for turning the design into production code. Start from `portfolio-mateo-zamora.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
## Source map
- Primary entry: `portfolio-mateo-zamora.html`
...
- A single self-contained `portfolio-mateo-zamora.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `portfolio-mateo-zamora.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `AntRig_Render.png`
- `AntRig.jpeg`
- `Dragon_Rig_Render-1.png`
- `Dragon_Rig_Render-2.png`
- `Dragon_Rig_Render.png`
- `image.png`
- `X9EXuuS7vrVchLr6-1.mp4`
- `X9EXuuS7vrVchLr6.mp4`

## Coding checklist for AI tools
1. Inspect `portfolio-mateo-zamora.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
